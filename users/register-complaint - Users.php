...
$complainno=$cmpn;
echo '<script> alert("Your grievance has been successfully filed and your grievance no is  "+"'.$complainno.'")</script>';
}
?>
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Lodge Grievance</h3>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Subject of Grievance</label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Grievance Details (max 2000 words) </label>
<div class="col-sm-6">
<textarea  name="complaindetails" required="required" cols="5" rows="5" class="form-control" maxlength="2000"></textarea>
</div>
</div>
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Grievance Related Document (if any) </label>
<div class="col-sm-6">
