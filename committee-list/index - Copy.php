...
<tbody>
<?php 
$query=mysqli_query($bd,"SELECT c.committeeName, m.salutation,m.name,cm.role, m.designation,m.department,m.contactNo,m.emailId FROM committee c, member m, `committee-member-mapping` cm WHERE c.id=cm.committeeId and cm.memberId=m.id ORDER BY c.committeeName");
