...
{
$sql=mysqli_query($bd,"SELECT password FROM committee where password='".$_POST['password']."' && loginName='".$_SESSION['alogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($bd,"update committee set password='".$_POST['newpassword']."', updationDate='$currentTime' where loginName='".$_SESSION['alogin']."'");
...
<head>
	...
	<title>Committee| Change Password</title>
