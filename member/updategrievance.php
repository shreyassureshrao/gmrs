...
try {
    ...
    $mail->Body    = 'Dear ' .$name. ', <br/> <br/> Please find below your grievance details <br/>
	
	<h4> Grievance Number: ' .$complaintnumber. '<br/> <br/> Subject of Grievance: ' .$subject. '<br/> <br/> Current Status: ' .$status. '<br/> <br/> Response by the Grievance committee: ' .$remark. '<br/> <br/>  Please checkin your dashboard at the URL: http://localhost/gmrs/users/ for more details. </h4> <br/> 
...
function f2()
{
document.forms['updateStatus'].submit();
...
<form name="updateStatus" id="updateStatus" method="post"> 
...
<br /> <br/>
	*Note: First click on "Submit" and later on "Close" buttons in the form.</td>
