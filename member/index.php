...
$ret=mysqli_query($bd,"SELECT * FROM committee WHERE loginName='$username' and password='$password'");
$num=mysqli_fetch_array($ret);
if($num>0)
{
$extra="unprocessed-grievances.php";//
...
<head>
	...
	<title>GMRS | Committee Member login</title>
		...
		<div class="navbar-inner">
			<div class="container">
				<a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
			  	...
			  	<a class="brand"> <img src="http://localhost/gmrs/img/grievance.jpg" width="100" height="100" />
			  		GMRS | Committee Member
			    </a>
