...
$num1 = mysqli_num_rows($rt);
{?><b class="label yellow pull-right"><?php echo htmlentities($num1); ?></b>
<?php } ?>
										</a>
									</li>
									<li>
...
<?php } ?>
									...
									<li>
										<a href="rejected-grievances.php">
											<i class="icon-inbox"></i>
											Rejected Grievances
	     <?php 
  
$rt = mysqli_query($bd,"SELECT * FROM tblcomplaints g,`committee-category-mapping` m, committee com where com.id='".$_SESSION['id']."' and 
m.committeeId=com.id and m.categoryId=g.category and g.status ='rejected'");
$num1 = mysqli_num_rows($rt);
